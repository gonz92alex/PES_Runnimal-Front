...
public class OwnerServiceImpl extends AbstractService implements OwnerService {
    ...
    @Override
    public void list(DisposableObserver<List<Owner>> callback){
        execute(ownerRepository.list(),callback);
    }
    ...
    @Override
    public void get(String email, DisposableObserver<Owner> callback) {
        execute(ownerRepository.get(email), callback);
    }
