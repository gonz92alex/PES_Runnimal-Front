...
public class StatisticsPresenter extends Presenter<StatisticsPresenter.View> {
    ...
    public void initialize() {
        super.initialize();
        getView().showLoading();//la operacion de training stats quizas tenga que llevar el id nolose aun
        statisticsService.getTrainingStats(
                new DisposableObserver<StatsTraining>() {
