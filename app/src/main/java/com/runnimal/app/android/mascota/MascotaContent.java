package com.runnimal.app.android.mascota;
...
public class MascotaContent {
    ...
    private static MascotaItem createMascotaItem(int position) {
        return new MascotaItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
